...
const PDF_BOOKS = [
    ...
    { title: "Linear Algebra Done Right", author: "Sheldon Axler", type: {en: "Mathematics", bn: "গণিত"}, desc: {en: "A clean, elegant approach to linear algebra", bn: "লিনিয়ার অ্যালজেব্রার পরিচ্ছন্ন ও মার্জিত রূপ"}, link: "https://linear.axler.net/LinearAlgebraDoneRight.pdf" },
    ...
    { title: "A Graduate Course in Applied Cryptography", author: "Boneh & Shoup", type: {en: "Applied", bn: "প্রয়োগ"}, desc: {en: "Where number theory secures the digital world", bn: "যেখানে সংখ্যাতত্ত্ব রক্ষা করে ডিজিটাল দুনিয়া"}, link: "https://toc.cryptobook.us/book.pdf" }
];
...
// --- View persistence for file:// local previews --------------------------------
// --- Routing ---------------------------------------------------------------
...
const NAV_STORAGE_KEY = 'ndcm_nav_state';
function saveNavState() {
    // Best-effort mirror only; the real routing source of truth is the URL path.
    try {
        sessionStorage.setItem(NAV_STORAGE_KEY, JSON.stringify({
            view: state.view,
            articleId: state.articleId
        }));
    } catch (e) { /* storage unavailable (sandboxed) -- ignore */ }
}
