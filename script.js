...
<ol class="list-decimal-bangla space-y-3 mb-8 pl-6">
    ...
    <li><span class="font-semibold">৪. যে দল জিতবে সে দলের সদস্যদের সর্বোচ্চ কর্মদক্ষতার ভিত্তিতে যথাক্রমে তিনজন বিজয়ী হবে।</span></li>
            ...
            <p class="mb-6">তুমি খুব করে চেষ্টা করলে প্রথম দুটো নিয়ম নিয়ে চিন্তা করতে কিন্তু বেশিদূর যেতে পারলে না, মিলাতে গিয়েও মিলাতে পারছোনা যে কতভাবে এবং কিভাবে সেই সেরা performer কে বাছাই করা যাবে এবং কতভাবে প্রতিটি সদস্যের বিপরীতে যেকোনো একজন বিশেষ প্রতিপক্ষদের নির্বাচন করা যাবে। ব্যর্থ হয়ে এখন তুমি মনে মনে ভাবছো তোমার দল যদি প্রতিযোগিতায় জিতে যায় তাহলে তাদের মধ্য থেকে ৩ জন ছাত্র নিয়ে কতভাবে বিজয়ী দল গঠন করতে পারবে। এখন তুমি পড়লে এক বিপদে! কি করবে কি করবে ভেবে কূল কিনারা পাচ্ছোনা। মাথায় একটা সহজ বুদ্ধি এসে গেলো, একটা নোট খাটা নিয়ে বসে পড়লে ও 
           ...
           <div class="bg-gray-100 p-6 rounded-xl my-6">
               ...
               <p>যদি একটি কাজ $m$ ভাবে এবং আরেকটি কাজ $n$ ভাবে করা যায়, তাহলে দুটি একসাথে $ m \\times n $ ভাবে করা যায়।</p>
           ...
           <div class="bg-gray-100 p-6 rounded-xl my-6">
               <p class="font-semibold mb-2">৩. বিন্যাস (Permutation)</p>
